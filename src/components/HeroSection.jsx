  ...
  return (
    <section className="relative z-10 pt-[220px] pb-24 px-6 min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-forge-surfaceAlt/40 backdrop-blur-[17px] border border-forge-border shadow-[0_0_20px_rgba(249,115,22,0.15)] mb-8 hover:border-forge-borderStrong transition-colors cursor-pointer group">
        ...
        <span className="text-forge-textSec group-hover:text-forge-text text-sm font-medium transition-colors">Introducing OneForge 2.0</span>
      ...
      <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-center max-w-5xl leading-[1.05] mb-6">
        What will you <br className="hidden md:block" />
      ...
      <p className="text-xl text-forge-textSec text-center max-w-2xl mb-12">
        Deploy full-stack applications with an AI-native build system. <br className="hidden sm:block" />
        From natural language to production code in seconds.
      </p>
      ...
      <div className="w-full max-w-3xl relative group">
        ...
        <div className="relative bg-forge-surfaceAlt/80 backdrop-blur-[17px] border border-forge-border rounded-2xl p-2 shadow-2xl flex flex-col transition-all focus-within:border-forge-primary/50">
          <textarea
            ...
            placeholder="Describe your next project... e.g. 'Build a SaaS dashboard for a local coffee shop with Stripe integration.'"
          />
      ...
      <div className="mt-8 flex items-center gap-4 text-sm">
        ...
        <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-forge-surface border border-forge-border hover:border-forge-borderStrong hover:text-forge-text text-forge-textSec transition-colors">
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none">
            <path d="M16 12a4 4 0 1 1 0-8 4 4 0 0 1 0 8zM8 12a4 4 0 1 1 0-8 4 4 0 0 1 0 8z" fill="#0acf83" />
            <path d="M8 20a4 4 0 1 1 0-8 4 4 0 0 1 0 8z" fill="#a259ff" />
            <path d="M16 16a4 4 0 1 1-8 0 4 4 0 0 1 8 0z" fill="#f24e1e" />
            <path d="M8 24a4 4 0 1 1 0-8 4 4 0 0 1 0 8z" fill="#ff7262" />
            <path d="M12 12L8 8v8l4-4z" fill="#1abcfe" />
          </svg>
          Figma Link
        </button>
      </div>
